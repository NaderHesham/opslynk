const IPC = {
  ...
  clearHelpRequests: () => window.OpsLynk.clearHelpRequests(),
  ...
  dismissChatPopup: () => window.OpsLynk.dismissChatPopup?.(),
  chatPopupReplyIntent: data => window.OpsLynk.chatPopupReplyIntent?.(data),
  chatPopupOpenChat: data => window.OpsLynk.chatPopupOpenChat?.(data),
  ...
  stopForcedVideoBroadcast: data => window.OpsLynk.stopForcedVideoBroadcast(data),
  auth: {
    listUsers: () => window.OpsLynk.auth.listUsers(),
    verifyPassword: data => window.OpsLynk.auth.verifyPassword(data),
